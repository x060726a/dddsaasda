...
<div class="main">
    <div class="other-header">
        ...
        <div class="title"><span>团队报表详情</span></div>
        ...
        <div class="res-table" ref="Scroll">
            <div class="xs-container" :class="{'mohu':isSendingHttp}">
                <div class="xs-content">
                    ...
                    <div class="block"><span>直属投注：</span><span>{{res.directly_bets}}</span></div>
                    <div class="block"><span>团队投注：</span><span>{{res.bets}}</span></div>
                    <div class="block"><span>团队中奖：</span><span>{{res.bonus}}</span></div>
                    <div class="block"><span>返点比率：</span><span>{{res.fandian_rate}}</span></div>
                    <div class="block"><span>盈利总额：</span><span>{{res.profit}}</span></div>
                    <div class="block"><span>团队充值：</span><span>{{res.deposit}}</span></div>
                    <div class="block"><span>团队提款：</span><span>{{res.withdrawal}}</span></div>
                    <div class="block no-b-b"><span>团队返水：</span><span>{{res.fandian}}</span></div>
                </div>
            </div>
