...
<div class="main">
    ...
    <div class="content">
        <div class="top">
            <div class="done">
                <h1>提现成功，已提交信息</h1>
                <p>{{$route.query.bankname}}提现</p>
                <p>{{JSON.parse($route.query.data).coin}}元</p>
                <i></i>
            </div>
            <div class="undone">
                <h1>预计{{new Date(JSON.parse($route.query.data).accounting_time*1000).getHours()+':'+new Date(JSON.parse($route.query.data).accounting_time*1000).getMinutes()}}前到账</h1>
                <p>以实际到账为准</p>
                <i></i>
            </div>
        </div>
